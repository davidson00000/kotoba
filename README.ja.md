...
**プログラムダッシュボード**: [docs/DASHBOARD.ja.md](docs/DASHBOARD.ja.md) — 現在のフェーズ、スプリント、RAG、今週誰が何をするか。
...
すべての成果物は `*.ja.md` に日本語版、`*.md` に英語版が対で存在する。
